...
import RepaymentDetailsComponent from './RepaymentDetails';

interface RepaymentsDataTableProps {
...
export function RepaymentsDataTable({
  columns,
  data,
  emptyMessage = 'No records to display.',
}: RepaymentsDataTableProps) {
  ...
  // Handle row edit
  const handleRowEdit = async (rowData: Repayment) => {
  ...
  return (
    <div>
      ...
      {isEditModalOpen && editingRowData && (
        ...
        >
          <RepaymentDetailsComponent repayment={editingRowData} />
        </SideModal>
      )}
    </div>
  );
