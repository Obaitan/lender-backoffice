...
import { RecoveredPayment, createColumns } from './RecoveredDebtsColumns';
import SideModal from '@/components/layout/SideModal';
import RecoveryDetailsComponent from './RecoveryDetails';

interface RecoveredDebtsDataTableProps {
  columns?: ColumnDef<RecoveredPayment>[];
  data: RecoveredPayment[];
...
export function DataTable({
  ...
  const table = useReactTable({
    data,
    columns: tableColumns as ColumnDef<RecoveredPayment>[],
  ...
  return (
    <div>
      ...
      {isModalOpen && selectedRecoveryData && (
        <SideModal isOpen={isModalOpen} onClose={() => setModalOpen(false)}>
          <RecoveryDetailsComponent recoveryData={selectedRecoveryData} />
        </SideModal>
      )}
    </div>
  );
